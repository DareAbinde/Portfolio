...
- The concept triggers a lightweight prompt after repeated manual signature removals, offering remove signature, edit signature, or keep signature.
- The technical direction uses simple deterministic rules around repeated removals, recency, and replacement patterns stored locally on the user's device. AI or machine learning could become useful only for more ambiguous behavioural nuance.
